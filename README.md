...
* ****`substractNumbers (uint256) _firstNumber, uint256 _secondNumber`****: Subtracts `_secondNumber` from `_firstNumber` and returns the result. Includes a validation check to ensure the
