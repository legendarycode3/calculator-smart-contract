...
* ****Blockchain Execution:**** Functions are intended to run on the Ethereum Virtual Machine
...
* No persistent storage variables such as `uint256 public value;` are declared in the contract.
